...
#define DBUS_NAME "org.heera.Launcher"
#define DBUS_PATH "/Launcher"
#define DBUS_INTERFACE "org.heera.Launcher"

int main(int argc, char *argv[])
{
    QCoreApplication::setAttribute(Qt::AA_EnableHighDpiScaling);

    QByteArray uri = "org.heera.launcher";
    ...
    app.setApplicationName(QStringLiteral("heera-launcher"));
    ...
    QLocale locale;
    QString qmFilePath = QString("%1/%2.qm").arg("/usr/share/heera-launcher/translations/").arg(locale.name());
